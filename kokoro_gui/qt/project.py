...
`engines/<id>/...`), imported audio under `audio/imported/` (the source
track `Document.settings["source_track"]` names included, phase 5 D5),
and, when `include_video` is on, the reference video under `video/`
(phase 5, TB16). A `.json` project (the 4.0-preview
